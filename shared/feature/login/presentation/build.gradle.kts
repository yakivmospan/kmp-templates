...
android {
    namespace = "com.yakivmospan.templates.feature.login.presentation"
...
multiplatformResources {
    resourcesPackage.set("com.yakivmospan.templates.feature.login.presentation")
