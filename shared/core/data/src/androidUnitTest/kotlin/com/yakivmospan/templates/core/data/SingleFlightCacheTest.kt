...
class SingleFlightCacheTest {
    ...
    // -------------------------------------------------------------------------
    // 2. executeFlow vs execute
    // -------------------------------------------------------------------------

    @Test
    fun `given execute, when called, then suspends until executor completes`() = testScope.runTest {
...
//        // Given
//        var callCount = 0
//        val cache = SingleFlightCommand<String, Int>(
//            scope = testScope,
//            executor = { _ -> callCount++; 42 }
//        )
//
//        // When
...
//        val cache = SingleFlightCommand<String, Int>(
//            scope = testScope,
//            executor = { _ -> callCount++; callCount },
//            keepFor = 1000.milliseconds,
//            timeSource = fakeTimeSource
//        )
//
...
//        val cache = SingleFlightCommand<String, Int>(
//            scope = backgroundScope,
//            executor = { _ -> throw RuntimeException("worker failed") }
//        )
//
//        // When / Then
//        assertFailsWith<RuntimeException> {
...
//            // Given
//            var innerResult = -1
//            lateinit var cache: SingleFlightCommand<String, Int>
//            cache = SingleFlightCommand(
//                scope = backgroundScope,
//                executor = { key ->
//                    if (key == "outer") {
